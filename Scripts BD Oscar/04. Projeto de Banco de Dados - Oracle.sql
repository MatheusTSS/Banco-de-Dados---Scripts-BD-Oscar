...
-- 1) Verificar a RestriÃ§Ã£o de Integridade Referencial para as tabelas:
...
-- 2) Verificar uma RestriÃ§Ã£o de DomÃ­nio qualquer
INSERT INTO Premio VALUES
('COD123', 'Melhor Roteiro');

-- 3) Verificar uma RestriÃ§Ã£o de Vazio qualquer

INSERT INTO Ator VALUES
(101, 'Lazaro Ramos', 'Salvador', NULL, 'M');

-- 4) Verificar a RestriÃ§Ã£o de Chave nas tabelas:
...
-- 5) Verificar a RestriÃ§Ã£o de Integridade na tabela Ator
